...
class OPAC(BrowserView):
    ...
    def _convertKeywords(self, data):
        ...
        for keyword in data.get('ddc', None) or []:
            if keyword in geo_mapping.values():
                data['ddcPlace'].append(keyword)
            if keyword in epoch_mapping.values():
                data['ddcTime'].append(keyword)
            if keyword in topic_mapping.values():
                data['ddcSubject'].append(keyword)
        data.pop('ddc')
