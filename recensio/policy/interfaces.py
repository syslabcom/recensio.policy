...
class INewsletterSettings(Interface):
    ...
    mail_template = schema.Text(
        title=_("Mail Template"),
        description=_(
            u"description_mailsettings_mail_template",
            default=u"The container for the complete template, Variable expansion will be applied. Provide the following slots: a b c",
        ),
...
""",
    ...
    subject = schema.TextLine(
        title=_("Subject"),
        description=_(
            u"description_mailsettings_subject",
            default=u"The subject of the e-mail. Thats what the user sees first when receiving the mail",
        ),
        default=_(u"""Recensio Newsletter"""),
    )
    mail_format = schema.ASCIILine(
        title=_("Date Format"),
        description=_(
            u"description_mailsettings_date_format",
            default=u"strftime compatible date format specification, see http://docs.python.org/library/time.html#time.strftime",
        ),
        default="%d.%m.%Y",
    )
    standard_result_template = schema.Text(
        title=_("Review template"),
...
""",
    ...
    comment_result_template = schema.Text(
        title=_("Review template for Discussion based searches"),
        default=u"""%(Title)s (%(getURL)s)
...
""",
    ...
    separator = schema.Text(
        title=_(u"Separator"),
        description=_(
            u"The separator will be used to separate sections of the email "
            "from each other."
        ),
        default=u"""*********************************************
...
""",
    ...
    archive_folder = schema.TextLine(
        title=_("Archive Folder"),
        description=_(
            u"description_mailsettings_archive_folder",
            default=u"The path of the folder where newsletter mails will be saved after they have been sent. Will be created when needed if it does not exist.",
        ),
...
class IRecensioSettings(Interface):
    ...
    review_submitted_email = schema.TextLine(
        title=_(
            u"label_review_submitted_email",
            default=u"E-mail " u"address for submitted reviews.",
        ),
        description=_(
            u"description_review_submitted_email",
            default=u"Enter "
    ...
    external_portal_url = schema.TextLine(
        title=_(u"label_external_portal_url", default=u"External URL of this portal"),
        description=_(
            u"description_external_portal_url",
            default=u"The URL "
    ...
    available_content_languages = schema.Text(
        title=_(
            u"label_available_content_languages",
            default=u"Available " u"languages for content in the site.",
        ),
        description=_(
            u"description_available_content_languages",
    ...
    show_thematic_search = schema.Bool(
        title=_(
            u"label_show_thematic_search",
            default=u'Show "Thematic search" section in the advanced ' "search",
        ),
        default=True,
    )
    ...
    xml_export_password = schema.TextLine(
        title=_(u"label_xml_export_password", default=u"Password for Chronicon export"),
        description=_(
            u"description_xml_export_password",
            default=u"Enter the password that belongs to the above " "SFTP user name.",
        ),
        required=False,
        default=u"",
    )
    ...
    xml_export_filename_prefix = schema.TextLine(
        title=_(
            u"label_xml_export_filename_prefix",
            default=u"File name prefix for Chronicon export",
        ),
        description=_(
            u"description_xml_export_filename_prefix",
    ...
    doi_prefix = schema.TextLine(
        title=_(u"label_doi_prefix", default=u"DOI Prefix"),
        description=_(
            u"description_doi_prefix", default=u"Prefix for autogenerated DOIs"
        ),
        required=True,
        default=u"10.15463/rec.",
    )

    doi_registration_url = schema.TextLine(
        title=_(u"label_doi_registration_url", default=u"URL for DOI registration"),
        description=_(
            u"description_doi_registration_url",
    ...
    doi_registration_username = schema.TextLine(
        title=_(
            u"label_doi_registration_username",
            default=u"User name for DOI registration",
        ),
        description=_(
            u"description_doi_registration_username",
            default=u"User name to use as login for registration of " "DOIs",
        ),
        required=False,
        default=u"",
    )
    ...
    doi_registration_password = schema.TextLine(
        title=_(
            u"label_doi_registration_password", default=u"Password for DOI registration"
        ),
        description=_(
            u"description_doi_registration_password",
