...
class TestSparql(unittest.TestCase):
    ...
    def testGetMetadata12(self):
        expected = {
            ...
            'keywords': [u'Geschichte 1918-1938', u'Minderheitenpolitik'
                         , u'Sudetendeutsche', u'Tschechoslowakei'],
            'language': u'Undetermined',
            'location': u'Praha',
            'pages': u'438',
            'publisher': u'Pulchra',
