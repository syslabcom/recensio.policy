...
class RecensioPolicyWithoutContent(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        ...
        xmlconfig.file("configure.zcml", recensio.policy, context=configurationContext)
...
RECENSIO_BARE_INTEGRATION_TESTING = IntegrationTesting(
    bases=(RECENSIO_FIXTURE_WITHOUT_CONTENT,),
    name="RecensioPolicy:IntegrationWithoutContent",
)
RECENSIO_INTEGRATION_TESTING = IntegrationTesting(
    bases=(RECENSIO_FIXTURE,), name="RecensioPolicy:Integration"
)
RECENSIO_FUNCTIONAL_TESTING = FunctionalTesting(
    bases=(RECENSIO_FIXTURE,), name="RecensioPolicy:Functional"
)
