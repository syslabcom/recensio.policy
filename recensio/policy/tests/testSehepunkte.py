...
testdata_parsed = [
    ...
    {'authors': [{'firstname': 'Mathias', 'lastname': 'Piana'}],
     ...
     'publisher': 'Michael Imhof Verlag',
     'reviewAuthors': [{'firstname': 'Lorenz', 'lastname': 'Korn'}],
     'series': ('Studien zur internationalen Architektur- und '
                'Kunstgeschichte Teil 2'),
     'subtitle': '',
     'title': u'Burgen und St\xe4dte der Kreuzzugszeit',
     'volume': '10',
     'year': '2010',
    ...
    {'authors': [{'firstname': 'Christian', 'lastname': 'Ewert'}],
     ...
     'publisher': u'Staatliche Museen Preu\xdfischer Kulturbesitz',
     'reviewAuthors': [{'firstname': 'Verena', 'lastname': 'Daiber'}],
     'series': 'Forschungen zur Islamischen Kunstgeschichte. Neue Folge',
     'subtitle': (u'Strukturen und Dekorelemente der Malereien im '
                  u'Aleppozimmer des Museums f\xfcr Islamische Kunst in '
                  u'Berlin'),
     'title': 'Das Aleppozimmer',
     'volume': '10',
     'year': '2010',
     'yearOfPublication': '2006'},
    {'authors': [{'firstname': 'Julia', 'lastname': 'Gonnella'},
     ...
     'reviewAuthors': [{'firstname': 'Verena', 'lastname': 'Daiber'}],
     'series': '',
     'subtitle': (u'The Aleppo Room in Berlin. International Symposium of the '
                  u'Museum f\xfcr Islamische Kunst - Staatliche Museen zu '
                  u'Berlin 12.-14. April 2002'),
    ...
    {'authors': [{'firstname': 'Christiane J.', 'lastname': 'Gruber'}],
     ...
     'title': (u'El Libro de la Ascensi\xf3n Mi&#703;rajnama Tim\xfarida. The '
    ...
    {'authors': [{'firstname': 'Adnan', 'lastname': 'Shiyyab'}],
     ...
     'subtitle': (u"Arch\xe4ologische und kunstgeschichtliche Untersuchungen "
                  u"unter besonderer Ber\xfccksichtigung der \xbbKirche von "
                  u"Ya'mun\xab"),
    ...
    {'authors': [{'firstname': 'Larissa', 'lastname': u'F\xf6rster'}],
     ...
     'publisher': 'Campus',
     'reviewAuthors': [{'firstname': u'D\xf6rte', 'lastname': 'Lerp'}],
     'series': '',
     'subtitle': ('Wie Deutsche und Herero in Namibia des Kriegs von 1904 '
                  'gedenken'),
    ...
    {'authors': [{'firstname': 'Holger', 'lastname': u'L\xf6ttel'}],
     ...
     'subtitle': (u'Englandbilder im amerikanischen S\xfcden und die '
                  u'Au\xdfenpolitik der Konf\xf6deration'),
    ...
    {'authors': [{'firstname': 'Paul', 'lastname': 'Griffiths'}],
     ...
     'reviewAuthors': [{'firstname': u'Andr\xe9', 'lastname': 'Krischer'}],
    ...
    {'authors': [{'firstname': 'Keith', 'lastname': 'Sidwell'}],
     ...
     'series': '',
     'subtitle': ('The Politics of Satirical Comedy during the Peloponnesian '
                  'War'),
    ...
    {'authors': [{'firstname': 'Sebastian', 'lastname': 'Joost'}],
     ...
     'subtitle': (u'Ausw\xe4rtige Politik als Mittel zur Durchsetzung '
    ...
    {'authors': [{'firstname': 'Lorenz', 'lastname': 'Korn'},
     ...
     'reviewAuthors': [{'firstname': 'Jens', 'lastname': u'Kr\xf6ger (i.R.)'}],
     ...
     'year': '2010',
     'yearOfPublication': '2010'},
    {'authors': [{'firstname': 'Robert', 'lastname': 'Hillenbrand'},
    ...
    {'authors': [{'firstname': 'Arndt', 'lastname': 'Brendecke'}],
     ...
     'reviewAuthors': [{'firstname': 'Pedro',
                         'lastname': u'Mart\xednez Garc\xeda'}],
     'series': '',
    ...
    {'authors': [{'firstname': 'Gertrude', 'lastname': 'Enderle-Burcel'},
     ...
     'publisher': 'WUJ',
     'reviewAuthors': [{'firstname': 'Uwe', 'lastname': u'M\xfcller'}],
     'series': '',
    ...
    {'authors': [{'firstname': 'Otfrid', 'lastname': 'Pustejovsky'}],
     ...
     'placeOfPublication': u'M\xfcnster / Hamburg / Berlin / London',
     'publisher': 'LIT',
     'reviewAuthors': [{'firstname': 'Martin', 'lastname': u'Z\xfcckert'}],
    ...
    {'authors': [{'firstname': 'Stefanie', 'lastname': 'Middendorf'}],
     ...
     'publisher': 'Wallstein',
     'reviewAuthors': [{'firstname': 'Dietmar', 'lastname': u'H\xfcser'}],
    ...
    {'authors': [{'firstname': 'Michael', 'lastname': 'Klinkenberg'}],
     ...
     'reviewAuthors': [{'firstname': 'Tonia', 'lastname': u'Sch\xfcller'}],
     'series': '',
     'subtitle': '',
