...
class TestOpacSearch(unittest.TestCase):
    def xtestSuccessfulSearch(self):
        ...
        should_be = [
            {
                "publisher": u"Markt+Technik-Verl.",
    ...
    Some Book|Einführung und Dokumentation zur Entwicklung von Webanwendungen<br><br>
        ...
        soup2 = BeautifulSoup("")
        self.assertEquals(
            u"Einführung und Dokumentation zur Entwicklung von Webanwendungen",
            createResult(soup1)["subtitle"].strip(),
        )
    ...
    def testAuthors(self):
        ...
        soup2 = BeautifulSoup(
            sampleblob.replace("Pelletier, Michel", "Pelletier, Michel, Maier")
        )
        soup3 = BeautifulSoup("")
    ...
    def testLocationPublisherYear(self):
        ...
        soup2 = BeautifulSoup(
            sampleblob.replace(
                ">München/Germany: Markt+Technik-Verl.: 2002: 380S., [8] Bl. : Ill., graph. Darst.",
                "",
            )
        )
        soup3 = BeautifulSoup()
    ...
    def testKeywords(self):
        ...
        soup2_res = createResult(soup2)
        self.assertEquals(
            [u"World Wide Web", u"Zope <Programm>", u"Server"], soup1_res["keywords"]
        )
